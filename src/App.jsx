  ...
  return (
    <>
     <div className="flex min-h-screen overflow-y-hidden">
      <div className="md:w-65 lg:block">
        <Sidebar />
      </div>
      <div className="flex flex-1 flex-col justify-center items-center w-full  md:flex-wrap xl:flex-nowrap lg:flex-row justify-center items-center lg:items-center gap-5 p-5 min-w-0 ">
