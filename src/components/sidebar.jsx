...
export default function Sidebar() {
  ...
  return (
    <>
      <button
        ...
        className={`absolute top-6 left-6 z-[9999] md:hidden p-2 text-gray-900 focus:outline-none hover:text-yellow-400 transition-colors duration-200 ${isOpen ? 'hidden' : 'block'
          }`}
      >
  ...
  ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:block lg:w-[320px]`}>
